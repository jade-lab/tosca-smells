...
def main(method='kmeans'):
    ...
    metrics = metrics[['url', 'lines_code', 'num_capabilities', 'num_interfaces', 'num_node_types', 'num_properties',
    ...
    merged_clusters.to_csv(os.path.join('data', f'clusters_significant_metrics_{method}.csv'), index=False)
